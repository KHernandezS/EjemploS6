...
<?php
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
		...
		<div class="container-fluid">
			...
			<!--<li role="presentation" class="active"><a href="#">Grupos</a></li>-->
              ...
              <li role="presentation"><a href="seccion.php">Salón</a></li>
            </ul>
        </div>
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar nuevas salones, debes de llenar todos los campos del siguiente formulario para poder registrarlo.
                </div>
            </div>
        </div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  <li><a href="seccion.php">Listado de salones</a></li>
				  <li class="active">Nueva salón</li>
				</ol>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Agregar salón</div>
				
                <form class="form-padding" method="post" action="?op=recibir" autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12">
                            <legend><i class="zmdi zmdi-flower"></i> &nbsp; Datos del salón</legend><br>
                        </div>
						
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="text" class="material-control tooltips-general" name="txtnomsecc" placeholder="Nombre de la salón" required=""  data-toggle="tooltip" data-placement="top" title="Escribe el nombre de la salón">
			...
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="text" class="material-control tooltips-general" name="txtcapaci" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" placeholder="Capacidad" maxlength="2" required=""  data-toggle="tooltip" data-placement="top" title="Capacidad">
					<span class="highlight"></span>
					<span class="bar"></span>
			...
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="text" class="material-control tooltips-general" name="txtubi" placeholder="Ubicacion del salón" required=""  data-toggle="tooltip" data-placement="top" title="Escribe la Ubicacion del salón">
					<span class="highlight"></span>
					<span class="bar"></span>
			...
			<div class="group-material">
				...
				<select class="material-control" name="cbodoce" id="doce" tooltips-general" data-toggle="tooltip" data-placement="top" title="Elige el instructor">
					<option value=""  selected="">Selecciona el instructor</option>
			...
			<!--<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="text" class="material-control tooltips-general" name="ubicacion" placeholder="Ubicacion" required=""  data-toggle="tooltip" data-placement="top" title="Escribe la ubicación">
					<span class="highlight"></span>
					<span class="bar"></span>
