...
<?php
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar una nuevo tema, debes de llenar todos los campos del siguiente formulario para poder registrarlo.
                </div>
            </div>
        </div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  <li><a href="clase.php">Listado de temas</a></li>
	...
	<div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Agregar una nuevo tema</div>
				
				
                <form class="form-padding" method="post" action="?op=recibir" autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12">
                            <legend><i class="zmdi zmdi-flower"></i> &nbsp; Datos de los temas</legend><br>
                        </div>
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="text" class="material-control tooltips-general" name="txtnomclase" placeholder="Nombre del tema" required=""  data-toggle="tooltip" data-placement="top" title="Escribe el nombre del tema">
			...
			<div class="group-material">
				<span>Periodo</span>
				<select class="material-control" name="cboano" id="periodo" tooltips-general" data-toggle="tooltip" data-placement="top" title="Elige el docente">
			...
			<div class="group-material">
				<span>Docente</span>
				<select class="material-control" name="cbodoce" id="docente" tooltips-general="" data-toggle="tooltip" data-placement="top" title="Elige el gupo">
			...
			<div class="group-material">
				<span>Evento</span>
				<select class="material-control" name="cboevento" id="grado" tooltips-general="" data-toggle="tooltip" data-placement="top" title="Elige el evento">
			...
			<div class="group-material">
				<span>Tipo</span>
				<select class="material-control" name="cbotip" tooltips-general" data-toggle="tooltip" data-placement="top" title="Elige el grado">
			...
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="text" class="material-control tooltips-general" name="txtinfo" placeholder="Nombre de la información" required=""  data-toggle="tooltip" data-placement="top" title="Escribe el nombre de la información">
					<span class="highlight"></span>
					<span class="bar"></span>
